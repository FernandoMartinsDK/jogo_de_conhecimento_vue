  ...
  <div>
    ...
    <template v-if="this.question">
      ...
      <section class="result" v-if="this.answerSubmitted">
        <h4 v-if="this.chosen_answer == this.correctAnswer" v-html="'✔️ Você acertou!!!'"></h4>
        <h4 v-else v-html="'❌ Você errou, que pena! A resposta certa seria: '+ this.correctAnswer +' !'"></h4>
